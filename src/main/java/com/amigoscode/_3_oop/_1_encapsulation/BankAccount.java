...
public class BankAccount {
    ...
    double deposit(double amount){
       ...
       balance += amount;
        logTransaction("you have add "+amount + " to you account");
        return balance;
    ...
    double withdraw(double amount){
        ...
        balance -= amount;
        logTransaction("you have withdraw " + amount + " from your account");
        return balance;
    }
    ...
    public String toString(){
        return "BankAccount{accountNumber= "+accountNumber +", "+ "ownerName = "+ ownerName +", "+ "= "+ ownerName + ", "+"balance= "+balance + "}";
    }
