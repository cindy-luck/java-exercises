...
public class DateExercises {
    ...
    public static LocalDate addToDate(LocalDate date, int days, int months, int years) {
        ...
        LocalDate dateDate = date;
        LocalDate dateDate1 = dateDate.plusDays(days);
        LocalDate dateDate2 = dateDate1.plusMonths(months);
        LocalDate dateDate3 = dateDate2.plusYears(years); //9/27/2027å
