...
public class MethodOverloading {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("sum of 1 and 2 and 3: "+ add(1, 2, 3));
        System.out.println("sum of 1.5 and 2.5: "+ add(1.5, 2.5));//  - add(1.5, 2.5)
        System.out.println("re-format hello: "+ format("hello"));//  - format("hello")
        System.out.println("re-format 42: "+format(42));//  - format(42)
        System.out.println(format("Score", 95));//  - format("Score", 95)
