...
public class LoopExercises {
    ...
    public static long factorial(int n) {
        ...
        for (int i = 1; i <= n; i++){
            ...
            accumulator *= i;
            System.out.println("current accumulator is "+ accumulator);
        }
        return accumulator;
    }
     ...
     * Example for rows=4:
     * 1      *    row 0    space: 3      4-0-1 = 3
     * 3     ***   row 1    space: 2      4-1-1 = 2
     * 5    *****  row 2    space: 1      4-2-1 = 1
     * 7   ******* row 3    space: 0      4-3-1 = 0
     *
