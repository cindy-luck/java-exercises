...
public class AccessModifiers {
    ...
    private String secrete = "original secrete";
    ...
    public String demonstrateInternalAccess(){
        this.secrete = "Internal access works!";
        String a = publicGreeting();
        String b = protectedGreeting();
        String c = packageGreeting();
        return "secrete value: " + secrete + a + b + c;
